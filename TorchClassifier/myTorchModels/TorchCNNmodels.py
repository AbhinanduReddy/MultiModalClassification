...
def create_vit(numclasses, img_shape):
    model_ft =  MyViT(
        img_shape, n_patches=7, n_blocks=2, hidden_d=8, n_heads=2, out_d=numclasses
    )
    return model_ft
...
class MyViT(nn.Module):
    def __init__(self, chw, n_patches=7, n_blocks=12, hidden_d=768, n_heads=12, out_d=1000):
